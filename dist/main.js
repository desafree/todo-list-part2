...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TodoConstructor)
/* harmony export */ });
...
class TodoConstructor {
  constructor({
    title,
    description,
    dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "eeee"),
    priority = "1",
    note = "",
    project = "none",
  }) {
...
localStorageArray.forEach((todo) => {
  const todoToBeAdded = new _modules_TodoConstructor_js__WEBPACK_IMPORTED_MODULE_0__["default"](todo);
  _modules_todoArray_js__WEBPACK_IMPORTED_MODULE_1__.todoArray.addTodo(todoToBeAdded);
});
